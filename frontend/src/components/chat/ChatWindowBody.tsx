...
const ChatWindowBody = () => {
  ...
  const fetchMoreMessages = async () => {
   ...
   const handleScrollSave = () => {
    ...
    sessionStorage.setItem(key, JSON.stringify({ scrollTop: container.scrollTop, scrollHeight: container.scrollHeight }));
  }
  ...
  if (!messages?.length) {
    return (
      <div className='flex h-full items-center justify-center text-muted-foreground'> Gửi tin nhắn đầu tiên</div>
