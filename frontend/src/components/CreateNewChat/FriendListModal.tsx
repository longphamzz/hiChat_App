        ...
        <DialogContent className="glass max-w-md" >
            ...
            <div className="space-y-4">
                ...
                <div className="space-y-2 max-h-60 overflow-y-auto">
                    ...
                    {friends.length === 0 && (<div className="text-center py-8 text-muted-foreground">
                        <Users className="size-12 mx-auto mb-3 opacity-50" />
                        <p className="text-lg">Bạn chưa có bạn bè nào</p>
                        <p className="text-sm">Hãy kết bạn để bắt đầu trò chuyện</p>
                    </div>)}
                </div>
